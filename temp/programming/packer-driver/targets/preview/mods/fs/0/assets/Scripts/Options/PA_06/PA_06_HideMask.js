System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Camera, Component, geometry, Node, PhysicsSystem, GameInfo, PA_06_GamePlay, IronSource, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _temp, _crd, ccclass, property, PA_06_HideMask;
  ...
  function _reportPossibleCrUseOfPA_06_GamePlay(extras) {
    _reporterNs.report("PA_06_GamePlay", "./PA_06_GamePlay", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      PA_06_GamePlay = _unresolved_3.PA_06_GamePlay;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "16043UvtY5Dz6BHu645goIl", "PA_06_HideMask", undefined);
      ...
      _export("PA_06_HideMask", PA_06_HideMask = (_dec = ccclass('PA_06_HideMask'), _dec2 = property(_crd && PA_06_GamePlay === void 0 ? (_reportPossibleCrUseOfPA_06_GamePlay({
        error: Error()
      }), PA_06_GamePlay) : PA_06_GamePlay), _dec3 = property(Camera), _dec(_class = (_class2 = (_temp = class PA_06_HideMask extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "PA_06_GamePlay", _descriptor, this);
      ...
      }, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "PA_06_GamePlay", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
